...
const faqs = [
  {
    ...
    answer:
      '95分のゼミが週2回あります。およそ1ヶ月に1回30分程度の発表の機会があります。オンラインツール（Slack, Cosense）を併用することで、教員のみならず学生同士でも活発に議論をしています。',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      '研究ガチ勢とそうでない人によって大きく異なると思いますが、B4の小松原さんの例を示しました。',
  },
  {
    id: 6,
    question: '修士の場合、どのような研究生活ですか？',
    answer:
      'こちらも研究ガチ勢とそうでない人によって大きく異なると思います。M1の丸橋くん, D1の牧野くんの例を示しました。',
  },
];
