...
const faqs = [
  {
    ...
    answer:
      "週1回90分のゼミがあります。およそ1ヶ月に1回30分程度の発表の機会があります。オンラインツール（Zoom, Scrapbox, miro）を併用することで、教員のみならず学生同士でも活発に議論をしています。",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      "研究ガチ勢とそうでない人によって大きく異なると思いますが、B4の渡邊さんの例を示しました。この回答をクリックしてください。",
  ...
  },
  {
    ...
    answer:
      "こちらも研究ガチ勢とそうでない人によって大きく異なると思います。M1の山口さんの例を示しました。この回答をクリックしてください。",
    href: "/lablife/master",
  },
  {
    id: 7,
